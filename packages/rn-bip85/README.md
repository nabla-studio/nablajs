...
A safe and fast implementation of [BIP85](https://github.com/bitcoin/bips/blob/master/bip-0085.mediawiki) for react native.

## 📖 Docs

[Docs](/docs/rn-bip85/index.md) are available through this repo. They are specified information about packages usage and implementation.
